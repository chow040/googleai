...
const LandingPage: React.FC<LandingPageProps> = ({ onStartAnalysis, onViewDemo, onLogin }) => {
  return (
    <div className="relative z-20 min-h-screen flex flex-col font-sans">
      ...
      {/* Hero Section */}
      <main className="flex-1 flex flex-col items-center justify-center px-4 text-center mt-12 md:mt-0 mb-20">
        ...
        {/* Feature Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-24 max-w-6xl w-full animate-fade-in-up delay-300 text-left px-4">
