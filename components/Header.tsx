...
const Header: React.FC<HeaderProps> = ({ 
  ...
  return (
    <header className="flex items-center justify-between py-6 px-4 md:px-8 border-b border-white/10 bg-slate-900/50 relative z-50">
      <div 
        ...
        <div className="relative" ref={menuRef}>
          {user ? (
            <div>
              ...
              {/* Dropdown */}
              {isMenuOpen && (
                <div className="absolute top-full right-0 mt-2 w-64 bg-slate-900 rounded-xl border border-white/10 shadow-2xl overflow-hidden animate-fade-in-up">
                  ...
                  <div className="p-2 space-y-1">
                    <button 
                      ...
                      className="w-full flex items-center gap-3 px-3 py-2 text-xs font-medium text-slate-300 rounded-lg hover:bg-slate-800 hover:text-white transition-colors"
                    >
                    ...
                    >
                      ...
                      Subscription
                      <span className="ml-auto bg-indigo-500/10 text-indigo-300 text-[9px] font-bold px-1.5 py-0.5 rounded border border-indigo-500/20">PRO</span>
                    </button>
                    <button className="w-full flex items-center gap-3 px-3 py-2 text-xs font-medium text-slate-300 rounded-lg hover:bg-slate-800 hover:text-white transition-colors">
